...
rclcpp::Subscription<geometry_msgs::msg::Float32MultiArray>::SharedPtr pixel_sub;
...
std_msgs::msg::Float32MultiArray pixel_in_data:
...
int main(int argc, char **argv)
{
    ...
    pixel_sub = node->create_subscription<std_msgs::msg::Float32MultiArray>("/object_center", qos_assured, std::bind(&pixel_cb, _1));
